...
public class MainFrame extends javax.swing.JFrame {
    ...
    private static final String clear = "clear square";
    private static final String check = "check answer";
    ...
    public MainFrame() {
        ...
        gameBoard1.getInputMap(IFW).put(KeyStroke.getKeyStroke("ENTER"), clear);
        gameBoard1.getInputMap(IFW).put(KeyStroke.getKeyStroke("S"), check);
    ...
    private class changeStateAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            for (Square s : board) {
                if (s.x == gameBoard1.px && s.y == gameBoard1.py) {
                    s.state = nState;
